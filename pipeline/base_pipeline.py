...
class BasePipeline:
    ...
    def _get_pose_from_points_and_projection(self, track_slice, points_3d, R=None, T=None):
        ...
        assert not ((R is None) ^ (T is None)), "Either both R and T are None or none of the two"
